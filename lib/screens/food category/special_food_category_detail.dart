...
class _SpecificFoodCategoryDetailState
  ...
  addToCart(
    ...
    try {
      ...
      print(
          ".......$basePrice,$totalSidePrice,$quantity,${sideDrawerController.specificFoodResId.toString()},${sideDrawerController.SpecificFoodProId.toString()}");
                  ...
                  SingleChildScrollView(
                    child: Container(
                      ...
                      children: [
                        ...
                        //           BlendMode.darken,
                        //         ),
                        //         child: specialFoodDetail["restaurant_business_image"] != null &&
                        //             specialFoodDetail["restaurant_business_image"].toString().isNotEmpty
                        //             ? Image.network(
                        //           specialFoodDetail["restaurant_business_image"],
                        //           width: width,
                        //           height: height * 0.23,
                        //           fit: BoxFit.cover,
                          ...
                          child: Stack(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  customText.kText(
                                    specialFoodDetail['restaurant_name'] ?? "",
                                    28,
                                    FontWeight.w900,
                                    Colors.white,
                                    TextAlign.center,
                                  ...
                                  Container(
                                    ...
                                    child: customText.kText(
                                      specialFoodDetail['business_address'] ?? '',
                                      14,
                                      FontWeight.w900,
                                      Colors.white,
                                      TextAlign.center,
