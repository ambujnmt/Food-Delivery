...
class _FoodCategoryState extends State<FoodCategory> {
  ...
  viewAllFoodCategoryData({String orderby = ""}) async {
    setState(() {
      isApiCalling = true;
    });
    final response = await api.viewAllFoodCategory(orderBy: orderby);
    setState(() {
                      ...
                      slivers: [
                        ...
                        SliverGrid(
                          gridDelegate:
                            ...
                            maxCrossAxisExtent:
                                200.0, // make it 200 (before value)
