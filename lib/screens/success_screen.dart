              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(color: ColorConstants.kPrimary, width: 3),
                  ),
                  child: Center(
                    child: Container(
                ...
                customText.kText(TextConstants.successful, 35, FontWeight.w900,
                    Colors.black, TextAlign.center),
                SizedBox(
                  height: size.height * 0.01,
                ),
                customText.kText(TextConstants.passwordCreateSuccessDes, 16,
                    FontWeight.w600, Colors.black, TextAlign.center),
                const Spacer(),
                CustomButton(
                  fontSize: 24,
