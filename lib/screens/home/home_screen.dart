...
class _HomeScreenState extends State<HomeScreen> {
  ...
  customHeading(String title, Function() onTap) {
    return Padding(
      padding: EdgeInsets.fromLTRB(size.width * 0.03, size.height * 0.01, size.width * 0.03, 0),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          customText.kText(title, 20, FontWeight.w700, ColorConstants.kPrimary, TextAlign.center),
          GestureDetector(
            child: customText.kText(TextConstants.viewAll, 14, FontWeight.w700, Colors.black, TextAlign.center),
            onTap: onTap,
          )
        ],
      ),
      ...
      child: Column(
        children: [
          ...
          SizedBox(
            ...
            child: Center(
              child: customText.kText(title, 14, FontWeight.w700, ColorConstants.kPrimary, TextAlign.center, TextOverflow.ellipsis, 1),
            ),
          )
          ...
          child: Column(
            ...
            children: [
                    ...
                    Center(
                      child: Column(
                        children: [
                          ...
                          customText.kText(TextConstants.getReady, 20, FontWeight.w900, Colors.white, TextAlign.center),
                          SizedBox(height: size.height  * 0.01,),
                          customText.kText(TextConstants.toJoiWithUs, 24, FontWeight.w900, Colors.white, TextAlign.center),
                          SizedBox(height: size.height  * 0.01,),
                          GestureDetector(
                            child: Container(
                              height: size.height * 0.04,
                              ...
                              child: Center(
                                child: customText.kText(TextConstants.bookTable, 14, FontWeight.w700, Colors.white, TextAlign.center),
                              ),
                            ),
                            onTap: () {},
                          )
              ...
              Padding(
                ...
                child: customText.kText("Welcome To Get Food Delivery.", 16, FontWeight.w700, ColorConstants.kPrimary, TextAlign.start)
              ),
              ...
              Padding(
                ...
                child: RichText(
                  text: TextSpan(
                    text: "The Only Place To Find Great Food Everyday In Your Neighbourhood. ",
                    style: customText.kTextStyle(16, FontWeight.w500, Colors.black),
                    children: [
                      TextSpan(
                        text: "Get Discounts. Earn Point",
                        style: customText.kTextStyle(16, FontWeight.w500, ColorConstants.kPrimary),
                      )
                    ]
                  )
                ),
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: size.width * 0.03, vertical: size.height * 0.005),
                child: customText.kText("Our Newest & Popular Food From Restaurant Near By.", 16, FontWeight.w700, ColorConstants.kPrimary, TextAlign.start),
              ),

              Padding(
                padding: EdgeInsets.symmetric(horizontal: size.width * 0.03, vertical: size.height * 0.005),
                child: customText.kText("Delivery On Your Time And Easy To Pickup.", 16, FontWeight.w500, Colors.black, TextAlign.start),
              ),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        customText.kText("Restaurant 1", 14, FontWeight.w700, ColorConstants.kPrimary, TextAlign.start),
                        customText.kText("0.7 Mls", 12, FontWeight.w400, Colors.black, TextAlign.start)
                      ],
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        customText.kText("Restaurant 2", 14, FontWeight.w700, ColorConstants.kPrimary, TextAlign.start),
                        customText.kText("0.9 Mls", 12, FontWeight.w400, Colors.black, TextAlign.start)
                      ],
                    ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        customText.kText("Restaurant 3", 14, FontWeight.w700, ColorConstants.kPrimary, TextAlign.start),
                        customText.kText("1.2 Mls", 12, FontWeight.w400, Colors.black, TextAlign.start)
                      ],
                    ),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    customText.kText(TextConstants.foodCategoryDes, 14, FontWeight.w500, Colors.black, TextAlign.start),
                    SizedBox(height: size.height * 0.01,),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
              ...
              Align(
                alignment: Alignment.center,
                child: customText.kText(TextConstants.getFoodDelivery, 20, FontWeight.w700, Colors.black, TextAlign.center),
              ),
              ...
              Align(
                alignment: Alignment.center,
                child: customText.kText("Atlantic City", 20, FontWeight.w700, Colors.black, TextAlign.center),
              ),

              customHeading(
                  TextConstants.topRestaurants,
                      () {
