...
class _HomeScreenState extends State<HomeScreen> {
  ...
  int indexValue = 0, currentIndex = 0, nearByCurrentIndex = 0,
    foodCategoryCurrentIndex = 0, bestDealsCurrentIndex = 0,
    topRestaurantCurrentIndex = 0, specialFoodCurrentIndex = 0;
  ...
  Future<void> getCurrentLocation() async {
    ...
    try {
      ...
      List<geocode.Placemark> placemarks = await geocode.placemarkFromCoordinates(position.latitude, position.longitude);
      ...
      print("get lat: ${locationController.lat} --- get long ${locationController.long}");
      box.write('latOfUser', locationController.lat);
      box.write('longOfUser', locationController.long);

      if (locationController.lat.isNotEmpty && locationController.long.isNotEmpty) {
        sendCurrentLocation();
                    ...
                    itemBuilder: (BuildContext context, int index, int realIndex) {
                      ...
                      return GestureDetector(
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: size.height * 0.01), // Add spacing if needed
                              customText.kText(
                        ...
                        onTap: () {
                          ...
                          sideDrawerController.restaurantId = restaurant["id"].toString();
                          sideDrawerController.detailRestaurantName = restaurant["business_name"].toString();
                          sideDrawerController.restaurantlatitude = restaurant["latitude"];
                          sideDrawerController.restaurantlongitude = restaurant["longitude"];
                          sideDrawerController.restaurantAddress = restaurant["business_address"];
                          sideDrawerController.restaurantImage = restaurant['business_image'];
                ...
                itemBuilder:
                  ...
                  return GestureDetector(
                    ...
                    onTap: () {
                      ...
                      sideDrawerController.foodCategoryId = foodCategory["id"].toString();
                      sideDrawerController.foodCategoryTitle = foodCategory["title"].toString();
                ...
                : CarouselSlider.builder(
                    ...
                    itemBuilder:
                      ...
                      return GestureDetector(
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(
                                      size.width * 0.02),
                                  image: DecorationImage(
                                    image: topRestaurants["business_image"] == "null"
                                        ? const AssetImage("assets/images/no_image.jpeg")
                                        : NetworkImage(topRestaurants["business_image"]),
                                    fit: BoxFit.cover,
                                  )),
                              ),
                        ...
                        onTap: () {
                          sideDrawerController.previousIndex.add(sideDrawerController.index.value);
                          sideDrawerController.restaurantId = topRestaurants["id"].toString();
                          sideDrawerController.detailRestaurantName = topRestaurants["business_name"].toString();
                          sideDrawerController.restaurantlatitude = topRestaurants["latitude"];
                          sideDrawerController.restaurantlongitude = topRestaurants["longitude"];
                          sideDrawerController.restaurantAddress = topRestaurants["business_address"];
                          sideDrawerController.restaurantImage = topRestaurants ['business_image'];
                      ...
                      itemBuilder:
                        ...
                        return GestureDetector(
                          ...
                          onTap: () {
                            ...
                            sideDrawerController.specialFoodName = specialFood['name'];
                            sideDrawerController.specialFoodImage = specialFood['image'];
                            sideDrawerController.specialFoodPrice = specialFood['price'];
                            sideDrawerController.specialFoodResId = specialFood['user_id'].toString();
                            sideDrawerController.specialFoodProdId = specialFood['id'].toString();
