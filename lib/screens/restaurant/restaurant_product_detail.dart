...
class _RestaurantProductDetailState extends State<RestaurantProductDetail> {
  ...
  foodDetail() async {
    ...
    if (response["status"] == true) {
      print("food details response$resproductDetail");
      setState(() {
        resproductDetail = response['data'];
        for (int i = 0; i < resproductDetail["extra_features"].length; i++) {
          extraFeatureList.add(resproductDetail["extra_features"][i]);
        ...
        if (resproductDetail["side_items"] != null) {
          for (var itemJson in resproductDetail["side_items"]) {
            extraSideItemList.add(SideItem.fromJson(itemJson));
          }
        }
        extraOftenBoughtList.clear();
        selectedOftenBoughtOptions.clear();
        if (resproductDetail["often_bought_with"] != null) {
          for (var groupJson in resproductDetail["often_bought_with"]) {
      ...
      print("special food detail: $resproductDetail");
      print("ex fea: $extraFeatureList");
  ...
  addToCart({
    ...
    //     ? double.tryParse(resproductDetail['price'].toString()) ?? 0.0
    ...
    // double oftenBoughtPrice =
    //     double.tryParse(oftenBoughtOptionGroupPrice ?? '0.0') ?? 0.0;
    //
    // print(
    ...
    // Parse and calculate the total price including side options and often bought items
    double basePrice = calculatedPrice == 0
        ? double.tryParse(resproductDetail['price']?.toString() ?? '0') ?? 0.0
        : calculatedPrice.toDouble();
    ...
    final response = await api.addItemsMultiToCart(
      userId: loginController.userId.toString(),
      // price: calculatedPrice == 0
      //     ? resproductDetail['price'].toString()
      //     : calculatedPrice.toString(),
            ...
            child: Container(
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration:  BoxDecoration(
                          ...
                          image: DecorationImage(
                              image: NetworkImage(resproductDetail["restaurant_business_image"]),
                              fit: BoxFit.fitWidth)),
                      child: Stack(
                              ...
                              children: [
                                customText.kText(
                                  // sideDrawerController.detailRestaurantName,
                                    resproductDetail['restaurant_name'] ?? "",
                                    28,
                                    FontWeight.w900,
                                    Colors.white,
                                    TextAlign.center),
                                ...
                                //         TextAlign.center),
                                customText.kText(
                                    calculateDistance(restaurantLat: resproductDetail['latitude'], restaurantLong: resproductDetail['longitude']),
                                    24,
                                    FontWeight.w700,
                                    Colors.red,
                                    TextAlign.center),
                    ...
                    // ///product image
                    // Image.network(resproductDetail["image_url"] ?? ""),
                    // Container(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        // Product Image with hero animation and improved styling
                        Container(
                          width: double.infinity,
                          height: 250,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 16),
                              // Calculated Price with highlight
                              Container(
                                width: double.infinity,
                                padding: const EdgeInsets.all(16),
                                decoration: BoxDecoration(
                                  color:  ColorConstants.kPrimary.withOpacity(0.05),
                                  borderRadius: BorderRadius.circular(12),
                                  border: Border.all(
                                    color: ColorConstants.kPrimary.withOpacity(0.2),
                                  ),
                                ),
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              ...
                              // Description Section
                              if (resproductDetail['description'] != null &&
                                  resproductDetail['description'].toString().isNotEmpty) ...[
                                Text(
                                  "About this item",
                                  style: TextStyle(
                                    fontSize: 18,
                    ...
                    //                   style: const TextStyle(
                    //                     fontSize: 16,
                    //                     color: Colors.black, // Changed from grey to black for better readability
                    //                   ),
                    //                   hint: const Text(
                    //                     "Select Side Item",
                    //                     style: TextStyle(
                    ...
                    //         String sidePriceId =
                    //             _sideitemChoose!.itemPrice.toString();
                    //         String selectedOptionPrice =
                    //             _selectedOption!.price.toString();
