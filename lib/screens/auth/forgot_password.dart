          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  customText.kText(TextConstants.forgotPassword, 26, FontWeight.w900, Colors.black, TextAlign.start),
                  SizedBox(height: size.height * 0.01,),
                  customText.kText(TextConstants.forgotDes, 16, FontWeight.w600, Colors.black, TextAlign.start),
                  SizedBox(height: size.height * 0.025,),
                  CustomFormField2(
                    controller: emailController,
                    keyboardType: TextInputType.emailAddress,
                    textInputAction: TextInputAction.done,
                    prefixIcon: const Icon(Icons.email, color: ColorConstants.kTextFieldBorder, size: 35,),
                  ...
                  CustomButton(
                    ...
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => OTPVerify(email: emailController.text) ));
                    },
                  )
                ],
              ),
