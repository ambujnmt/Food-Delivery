              ...
              child: Container(
                ...
                child: ListView(
                  children: [
                    ...
                    customText.kText(TextConstants.register, 32, FontWeight.w700, ColorConstants.kPrimary, TextAlign.center),
                    customText.kText(TextConstants.registerDes, 16, FontWeight.w400, ColorConstants.kPrimary, TextAlign.center),
                    ...
                    CustomFormField(
                      ...
                      // validator: (value) => ValidationRules().email(value),
                      prefixIcon: const Icon(Icons.phone_android, color: ColorConstants.kPrimary, size: 35,),
                    ...
                    CustomFormField(
                      ...
                      keyboardType: TextInputType.text,
                      // validator: (value) => ValidationRules().email(value),
                      prefixIcon: const Icon(Icons.password, color: ColorConstants.kPrimary, size: 35,),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: selectedLocation == 1 ? ColorConstants.kPrimary : Colors.white,
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.home, size: 30, color: selectedLocation == 1 ? Colors.white : Colors.black,),
                                customText.kText(TextConstants.home, 18, FontWeight.w900, selectedLocation == 1 ? Colors.white : Colors.black, TextAlign.center)
                              ],
                            ),
                          ),
                          onTap: () {
                        ...
                        GestureDetector(
                          child: Container(
                            ...
                            padding: const EdgeInsets.symmetric(horizontal: 5, vertical: 2),
                            decoration: BoxDecoration(
                              color: selectedLocation == 2 ? ColorConstants.kPrimary : Colors.white,
                              border: Border.all(color: ColorConstants.kPrimary, width: 2),
                              borderRadius: BorderRadius.circular(size.width * 0.02),
                            ),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children: [
                                Icon(Icons.work, size: 30, color: selectedLocation == 2 ? Colors.white : Colors.black,),
                                customText.kText(TextConstants.home, 18, FontWeight.w900, selectedLocation == 2 ? Colors.white : Colors.black, TextAlign.center)
                              ],
                            ),
                          ),
                          onTap: () {
                        ...
                        GestureDetector(
                          child: Container(
                            ...
                            padding: const EdgeInsets.symmetric(horizontal: 5, vertical: 2),
                            decoration: BoxDecoration(
                              color: selectedLocation == 3 ? ColorConstants.kPrimary : Colors.white,
                              border: Border.all(color: ColorConstants.kPrimary, width: 2),
                              borderRadius: BorderRadius.circular(size.width * 0.02),
                            ),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children: [
                                Icon(Icons.apartment, size: 30, color: selectedLocation == 3 ? Colors.white : Colors.black,),
                                customText.kText(TextConstants.other, 18, FontWeight.w900, selectedLocation == 3 ? Colors.white : Colors.black, TextAlign.center)
                              ],
                            ),
                          ),
                          onTap: () {
